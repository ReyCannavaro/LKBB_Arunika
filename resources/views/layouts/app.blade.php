    ...
    <header class="bg-red-700 text-white p-4 shadow-md">
        <div class="container mx-auto flex justify-between items-center relative">
            ...
            <div class="flex items-center absolute left-0 ml-4">
                ...
                <a href="/" class="text-2xl font-bold">LKBB Arunika</a>
            </div>

            {{-- Navigasi di Tengah --}}
            <nav class="flex-grow flex justify-center">
                <ul class="flex space-x-8">
                    <li><a href="#beranda" class="hover:text-red-200">Beranda</a></li>
                    <li><a href="#tentang" class="hover:text-red-200">Tentang</a></li>
                    <li><a href="#juri" class="hover:text-red-200">Juri</a></li>
                    {{-- Tombol Daftar akan diarahkan ke dashboard --}}
                    <li><a href="{{ route('dashboard') }}" class="hover:text-red-200">Daftar</a></li>
                </ul>
            </nav>
            ...
            <div class="absolute right-0 mr-4">
                @auth {{-- Laravel Blade directive: tampilkan jika user login --}}
                    <a href="{{ route('profile.show') }}" class="flex items-center space-x-2 hover:text-red-200">
